    ...
    >
      <div>
        ...
        <p class="mt-4 text-gray-500">
          ¡Hola!, soy Desarrollador Fullstack. Mi objetivo es generar
          experiencia en el área del Desarrollo Web y colaborar a que la empresa
          para la que trabaje pueda dar un servicio de calidad a sus clientes
